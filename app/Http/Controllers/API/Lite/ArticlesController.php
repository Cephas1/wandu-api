...
class ArticlesController extends Controller
{
    ...
    {
        $products = Article::orderBy('name', 'asc')->get()->load('category', 'rubrique');
    ...
    {
        $article = Article::where([['deleted_at', null],['id', $id]])->first()->load('category', 'rubrique');
    ...
    public function create()
    {
        ...
        $rubriques = Rubrique::orderBy('name')->get();
        ...
        return response()->json([
            'meta' => $meta,
            'data' => ['categories' => $categories, 'rubriques' => $rubriques]
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->rubrique_id = $request['rubrique_id'];
    ...
    public function edit($id) {
        ...
        return response()->json([
            'meta' => $meta,
            'data' => ['categories' => $categories, 'rubriques' => $rubriques, 'product' => $product]
        ]);
    }
